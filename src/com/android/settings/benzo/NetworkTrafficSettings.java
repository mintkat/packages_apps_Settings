...
public class NetworkTrafficSettings extends SettingsPreferenceFragment
    ...
    private static final String NETWORK_TRAFFIC_HIDE_ARROWS = "network_traffic_hidearrow";
    ...
    private SwitchPreference mNetTrafficArrowshide;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mNetTrafficArrowshide =
            (SwitchPreference) prefSet.findPreference(NETWORK_TRAFFIC_HIDE_ARROWS);
        mNetTrafficArrowshide.setChecked((Settings.System.getInt(getContentResolver(),
                            Settings.System.NETWORK_TRAFFIC_HIDEARROW, 0) == 1));
        mNetTrafficArrowshide.setOnPreferenceChangeListener(this);
    ...
    private void updateNetworkTrafficState(int mIndex) {
        if (mIndex <= 0) {
            mNetTrafficUnit.setEnabled(false);
            mNetTrafficPeriod.setEnabled(false);
            mNetTrafficArrowshide.setEnabled(false);
            mNetTrafficAutohide.setEnabled(false);
            mNetTrafficAutohideThreshold.setEnabled(false);
        } else {
            mNetTrafficUnit.setEnabled(true);
            mNetTrafficPeriod.setEnabled(true);
            mNetTrafficArrowshide.setEnabled(true);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mNetTrafficState) {
            ...
            return true;
        } else if (preference == mNetTrafficArrowshide) {
