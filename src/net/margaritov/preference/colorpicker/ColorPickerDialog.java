...
public class ColorPickerDialog extends Dialog implements
    ...
    private int mPalette = PALETTE_BENZO;
    ...
    public ColorPickerDialog(Context context, int theme, int initialColor,
            int androidColor, int benzoColor) {
        super(context, theme);
        mInitialColor = initialColor;
        mAndroidColor = androidColor;
        mBenzoColor = benzoColor;
    ...
    public boolean onMenuItemClick(MenuItem item) {
        if (item.getItemId() == R.id.palette_benzo) {
            mPalette = PALETTE_BENZO;
            mColorTransitionAnimator.start();
            return true;
            ...
            return true;
        } else if (item.getItemId() == R.id.reset_benzo) {
            mColorPicker.setColor(mBenzoColor, true);
            return true;
        }
        return false;
    }
